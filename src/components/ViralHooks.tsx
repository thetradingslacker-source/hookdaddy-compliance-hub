...
const ViralHooks = () => {
  return (
    <section id="viral-hooks" className="section-padding bg-background relative overflow-hidden">
      {/* Background elements */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-tesla-blue/5 rounded-full blur-3xl"></div>
      <div className="absolute bottom-0 left-0 w-80 h-80 bg-success/5 rounded-full blur-3xl"></div>
      ...
      <div className="container-width relative z-10">
        <div className="text-center mb-20 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed mb-8">
            Get instant access to our <strong className="text-foreground">Viral Hooks Pack</strong>—a proven collection 
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <Card className="group elevated-card hover:shadow-tesla transition-all duration-500 border-0 bg-card/80 backdrop-blur-sm overflow-hidden relative">
            ...
            <CardContent className="p-8 text-center relative z-10">
              ...
              <h3 className="text-2xl font-bold text-foreground mb-4">Proven to Convert</h3>
        ...
        {/* CTA Section */}
        <div className="text-center glass-effect rounded-3xl p-12 lg:p-16">
          <div className="max-w-3xl mx-auto">
            ...
            >
              <Button 
                size="lg" 
                className="tesla-gradient text-white text-xl px-12 py-6 rounded-xl shadow-tesla hover:shadow-elevated transition-all duration-300 group font-semibold"
              >
